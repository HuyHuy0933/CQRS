...
namespace SalaryCalculator.Infra.Persistent.Migrations
{
    ...
    [Migration("20201127025851_addEncryptedEmpMonthlyRecordTable")]
    partial class addEncryptedEmpMonthlyRecordTable
    {
            ...
            modelBuilder.Entity("SalaryCalculator.Infra.Persistent.Entities.EncryptedEmpMonthlyEnteredRecord", b =>
                {
                    ...
                    b.HasIndex("EncryptedDate")
                        .IsUnique()
                        .HasFilter("[EncryptedDate] IS NOT NULL");
